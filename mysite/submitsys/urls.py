...
urlpatterns = [
    ...
    path('courses/assignments', views.assignment_console, name='assignment_console'),
    path('courses/assignments/create', views.assignment_create, name='assignment_create'),
